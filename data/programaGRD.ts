import { ProgramaFase } from '../types';

/** Id fijo del programa base (currículo con el que nació la app). Las fichas sin
 *  programa asignado usan este programa. */
export const GRD_PROGRAMA_ID = 'programa-grd';
export const GRD_PROGRAMA_NOMBRE = 'Gestión de Redes de Datos';

/** Currículo del programa Gestión de Redes de Datos (antes estaba fijo en CronogramaGeneralView). */
export const GRD_FASES: ProgramaFase[] = [
  {
    nombre: 'Inducción',
    color: '#f59e0b',
    textColor: '#ffffff',
